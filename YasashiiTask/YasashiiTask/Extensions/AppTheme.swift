...
enum AppTheme {
    ...
    static let cardBackground = Color(red: 0.99, green: 1.00, blue: 0.99)
    ...
    static let cardShadow = Color(red: 0.03, green: 0.34, blue: 0.25).opacity(0.20)
...
extension View {
    func polishedCard(cornerRadius: CGFloat = 18) -> some View {
        self
            .background(
                LinearGradient(
                    colors: [AppTheme.cardBackground, AppTheme.softGreen.opacity(0.45)],
                    startPoint: .topLeading,
                    endPoint: .bottomTrailing
                ),
